					...
					<div class="choose">
						<div class="chooseArea">
							...
							<dl v-for="spuSale in spuSaleAttrList" :key="spuSale.id">
								...
								<dd
									changepirce="0"
									:class="{ active: color.isChecked == 1 }"
									v-for="color in spuSale.spuSaleAttrValueList"
									:key="color.id"
									@click="changeActive(color, spuSale.spuSaleAttrValueList)"
								>
						...
						<div class="cartWrap">
							<div class="controls">
								...
								<a
									href="javascript:"
									class="mins"
									@click="buyNum > 1 ? buyNum-- : (buyNum = 1)"
									>-</a
								>
							</div>
							<div class="add">
